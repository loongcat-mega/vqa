...
\begin{sloppypar}
      ...
      % \subsection{BertOutput}

      % \begin{figure}[H]
      %       \centering
      %       \label{BertOutput}
      %       \includegraphics{BertOutput}
      %       \caption{BertOutput}
      % \end{figure}


      % \subsection{BertAttention}
      % \begin{figure}[H]
      %       \centering
      %       \label{BertAttention}
      %       \includegraphics{BertAttention}
      %       \caption{BertAttention}
      % \end{figure}


      % \subsection{BertIntermediate}
      % \begin{figure}[H]
      %       \centering
      %       \label{BertIntermediate}
      %       \includegraphics{BertIntermediate}
      %       \caption{BertIntermediate}
      % \end{figure}

      % \subsection{BertLayer}
      % \begin{figure}[H]
      %       \centering
      %       \label{BertLayer}
      %       \includegraphics{BertLayer}
      %       \caption{BertLayer}
      % \end{figure}
